...
export async function registrarPaciente(pacienteData) {
    ...
    try {
        ...
        // Insertar en tabla paciente (columnas verificadas contra la base de datos real)
        const [pacienteResult] = await db.query(
            'INSERT INTO paciente (Id_Usuario, FechaNacimiento, Sexo, EstadoCivil, Ocupacion, LugarOrigen, TelefonoEmergencia, ContactoFamiliar, Id_Estudiante_Registro) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)',
